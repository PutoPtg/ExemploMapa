 ...
 *
 */
public class MapBoxFragments extends AppCompatActivity implements PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mapbox_map_fragment);
    ...
    protected void onStop() {
        ...
        if(FlyToSource != null){
            FlyToSource.setClickable(false);
        }
        if(Navigate != null){
